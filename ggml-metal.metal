...
//////////////// 3
typedef void (kernel_mul_mv3_impl_t)(
        device const  void * src0,
        device const float * src1,
        device       float * dst,
        constant   int64_t & ne00,
...
template<kernel_mul_mv3_impl_t impl_fn>
kernel void kernel_mul_mv_id3(
        device const    char * src0s,
        device const    char * src1,
        device         float * dst,
        device const    char * ids,
...
typedef void (kernel_mul_mv_id3_t)(
        device const    char * src0s,
        device const    char * src1,
        device         float * dst,
        device const    char * ids,
...
template [[host_name("kernel_mul_mv_id_f32_f32")]]  kernel kernel_mul_mv_id_t kernel_mul_mv_id<kernel_mul_mv_f32_f32_impl>;
template [[host_name("kernel_mul_mv_id_f16_f32")]]  kernel kernel_mul_mv_id_t kernel_mul_mv_id<kernel_mul_mv_f16_f32_impl>;

template [[host_name("kernel_mul_mv_id_q8_0_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<kernel_mul_mv_q8_0_f32_impl>;
template [[host_name("kernel_mul_mv_id_q4_0_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<mul_vec_q_n_f32_impl<block_q4_0, N_DST, N_SIMDGROUP, N_SIMDWIDTH>>;
template [[host_name("kernel_mul_mv_id_q4_1_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<mul_vec_q_n_f32_impl<block_q4_1, N_DST, N_SIMDGROUP, N_SIMDWIDTH>>;
template [[host_name("kernel_mul_mv_id_q5_0_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<mul_vec_q_n_f32_impl<block_q5_0, N_DST, N_SIMDGROUP, N_SIMDWIDTH>>;
template [[host_name("kernel_mul_mv_id_q5_1_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<mul_vec_q_n_f32_impl<block_q5_1, N_DST, N_SIMDGROUP, N_SIMDWIDTH>>;
template [[host_name("kernel_mul_mv_id_q2_K_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<kernel_mul_mv_q2_K_f32_impl>;
template [[host_name("kernel_mul_mv_id_q3_K_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<kernel_mul_mv_q3_K_f32_impl>;
template [[host_name("kernel_mul_mv_id_q4_K_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<kernel_mul_mv_q4_K_f32_impl>;
template [[host_name("kernel_mul_mv_id_q5_K_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<kernel_mul_mv_q5_K_f32_impl>;
template [[host_name("kernel_mul_mv_id_q6_K_f32")]] kernel kernel_mul_mv_id_t kernel_mul_mv_id2<kernel_mul_mv_q6_K_f32_impl>;
template [[host_name("kernel_mul_mv_id_iq1_s_f32")]]   kernel kernel_mul_mv_id_t kernel_mul_mv_id2<kernel_mul_mv_iq1_s_f32_impl>;
template [[host_name("kernel_mul_mv_id_iq1_m_f32")]]   kernel kernel_mul_mv_id_t kernel_mul_mv_id2<kernel_mul_mv_iq1_m_f32_impl>;

template [[host_name("kernel_mul_mv_id_iq2_xxs_f32")]] kernel kernel_mul_mv_id3_t kernel_mul_mv_id3<kernel_mul_mv_iq2_xxs_f32_impl>;
template [[host_name("kernel_mul_mv_id_iq2_xs_f32")]]  kernel kernel_mul_mv_id3_t kernel_mul_mv_id3<kernel_mul_mv_iq2_xs_f32_impl>;
template [[host_name("kernel_mul_mv_id_iq3_xxs_f32")]] kernel kernel_mul_mv_id3_t kernel_mul_mv_id3<kernel_mul_mv_iq3_xxs_f32_impl>;
template [[host_name("kernel_mul_mv_id_iq3_s_f32")]]   kernel kernel_mul_mv_id3_t kernel_mul_mv_id3<kernel_mul_mv_iq3_s_f32_impl>;
template [[host_name("kernel_mul_mv_id_iq2_s_f32")]]   kernel kernel_mul_mv_id3_t kernel_mul_mv_id3<kernel_mul_mv_iq2_s_f32_impl>;
template [[host_name("kernel_mul_mv_id_iq4_nl_f32")]]  kernel kernel_mul_mv_id3_t kernel_mul_mv_id3<kernel_mul_mv_iq4_nl_f32_impl>;
#if QK_K != 64
template [[host_name("kernel_mul_mv_id_iq4_xs_f32")]]  kernel kernel_mul_mv_id3_t kernel_mul_mv_id3<kernel_mul_mv_iq4_xs_f32_impl>;
#endif
